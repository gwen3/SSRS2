...
select fact.t_ttyp as Journal
,fact.t_ninv as Document
,fact.t_line as NumeroLigne
,fact.t_tpay as CodeTypeDocument
...
,motif.t_desc as LibelleMotifBlocage 
,fact.t_bref as ApprobateurAssigne
,appro.t_desc as LibelleApprobateurAssigne
...
from ttfacp200500 fact --Factures et Règlements Fournisseurs
inner join ttccom100500 tier on tier.t_bpid = fact.t_ifbp --Tiers
left outer join ttfacp002500 motif on motif.t_bloc = fact.t_bloc --Motif de Blocage
left outer join ttfacp003500 appro on appro.t_bref = fact.t_bref --Approbateur Assigné
