...
--rajout par rbesnier le 13/03/2019 suite au mail de Louis Renié du 11/03/2019
and opt.t_prdt between @datedeb_f and @datedeb_t --Bornage sur la date de début planifiée des opérations
and opt.t_trno between @datefin_f and @datefin_t --Bornage sur la date de fin planifiée des opérations
