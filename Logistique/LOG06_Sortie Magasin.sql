...
where left(line.t_cwar, 2) between @ue_f and @ue_t --Bornage sur l'UE
and omag.t_pddt between @pddt_f and @pddt_t --Date Livraison Planifiee
and line.t_cwar between @cwar_f and @cwar_t --Filtre Magasin
and line.t_lsta between @lsta_f and @lsta_t --Statut Ligne
