...
declare @datet_f date = '01/01/2020';
declare @datet_t date = getdate();
declare @traite_f nvarchar(9) = '1';
declare @traite_t nvarchar(9) = '1';
...
and dontemp.t_trdt between @datet_f and @datet_t --Bornage sur la date de Transaction
and dontemp.t_proc between @traite_f and @traite_t --Bornage sur le statut Traité
) union all 
--Heures Fabrication
...
where donof.t_trdt between @datet_f and @datet_t --Bornage sur la date de Transaction
and donof.t_proc between @traite_f and @traite_t --Bornage sur le statut Traité
) union all 
--Heures Projet
...
where hdprj.t_trdt between @datet_f and @datet_t --Bornage sur la date de Transaction
and hdprj.t_proc between @traite_f and @traite_t --Bornage sur le statut Traité
) union all 
--Heures PCS
...
where donprj.t_trdt between @datet_f and @datet_t --Bornage sur la date de Transaction
and donprj.t_proc between @traite_f and @traite_t --Bornage sur le statut Traité
) union all 
--Heures Service
...
where donos.t_trdt between @datet_f and @datet_t --Bornage sur la date de Transaction
and donos.t_proc between @traite_f and @traite_t --Bornage sur le statut Traité
)