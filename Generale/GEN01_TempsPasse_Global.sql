---------------------------------
-- GEN01 - Temps Passé - Global
---------------------------------

SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED;
/*
declare @jour_f date = '01/01/2018';
declare @jour_t date = getdate();
declare @emp_f nvarchar(9) = ' ';
declare @emp_t nvarchar(9) = 'ZZZZZZZZZ';
declare @traite_f nvarchar(9) = '1';
declare @traite_t nvarchar(9) = '10';
declare @cc_f nvarchar(9) = 'LVC000';
declare @cc_t nvarchar(9) = 'ZZZZZZ';
declare @ue_f nvarchar(2) = 'LV';
declare @ue_t nvarchar(2) = 'SM';
*/
--Ajout du bornage sur 2 années différentes par rbesnier le 05/01/2018
--Heures Générales
if (datepart(year, @jour_f) != datepart(year, @jour_t)) --On regarde si l'année demandée est la même ou non
(
--On prend les jours de l'année du début
...
left outer join ttccom001500 emp on emp.t_emno = dontemp.t_emno --Employés
...
and ((dontemp.t_peri between datepart(dayofyear, @jour_f) and 365 and dontemp.t_year = datepart(year, @jour_f)) or (dontemp.t_peri between 1 and datepart(dayofyear, @jour_t) and dontemp.t_year = datepart(year, @jour_t))) --Bornage sur l'année
and dontemp.t_emno between @emp_f and @emp_t --Bornage sur l'Employé
and dontemp.t_proc between @traite_f and @traite_t --Bornage sur traite oui ou non
--rajout par rbesnier le 31/08/2017
and emp.t_cwoc between @cc_f and @cc_t --Bornage sur le Département de l'Employé
) union all 
--Heures Fabrication
...
and ((donof.t_peri between datepart(dayofyear, @jour_f) and 365 and donof.t_year = datepart(year, @jour_f)) or (donof.t_peri between 1 and datepart(dayofyear, @jour_t) and donof.t_year = datepart(year, @jour_t))) --Bornage sur l'année
and donof.t_emno between @emp_f and @emp_t --Bornage sur l'Employé
and donof.t_proc between @traite_f and @traite_t --Bornage sur traite oui ou non
--rajout par rbesnier le 31/08/2017
and emp.t_cwoc between @cc_f and @cc_t --Bornage sur le Département de l'Employé
) union all 
--Heures Projet
...
and ((hdprj.t_peri between datepart(dayofyear, @jour_f) and 365 and hdprj.t_year = datepart(year, @jour_f)) or (hdprj.t_peri between 1 and datepart(dayofyear, @jour_t) and hdprj.t_year = datepart(year, @jour_t))) --Bornage sur l'année
and hdprj.t_emno between @emp_f and @emp_t --Bornage sur l'Employé
and hdprj.t_proc between @traite_f and @traite_t --Bornage sur traite oui ou non
--rajout par rbesnier le 31/08/2017
and emp.t_cwoc between @cc_f and @cc_t --Bornage sur le Département de l'Employé
) union all 
--Heures PCS
...
and ((donprj.t_peri between datepart(dayofyear, @jour_f) and 365 and donprj.t_year = datepart(year, @jour_f)) or (donprj.t_peri between 1 and datepart(dayofyear, @jour_t) and donprj.t_year = datepart(year, @jour_t))) --Bornage sur l'année
and donprj.t_emno between @emp_f and @emp_t --Bornage sur l'Employé
and donprj.t_proc between @traite_f and @traite_t --Bornage sur traite oui ou non
--rajout par rbesnier le 31/08/2017
and emp.t_cwoc between @cc_f and @cc_t --Bornage sur le Département de l'Employé
) union all 
--Heures Service
...
and ((donos.t_peri between datepart(dayofyear, @jour_f) and 365 and donos.t_year = datepart(year, @jour_f)) or (donos.t_peri between 1 and datepart(dayofyear, @jour_t) and donos.t_year = datepart(year, @jour_t))) --Bornage sur l'année
and donos.t_emno between @emp_f and @emp_t --Bornage sur l'Employé
and donos.t_proc between @traite_f and @traite_t --Bornage sur traite oui ou non
--rajout par rbesnier le 31/08/2017
and emp.t_cwoc between @cc_f and @cc_t --Bornage sur le Département de l'Employé
)
) 
...
where dontemp.t_type = 1 
and left(dontemp.t_cwoc, 2) between @ue_f and @ue_t --Bornage sur l'UE
and dontemp.t_peri between datepart(dayofyear, @jour_f) and datepart(dayofyear, @jour_t) --Bornage sur le jour
and dontemp.t_year between datepart(year, @jour_f) and datepart(year, @jour_t) --Bornage sur l'année
and dontemp.t_emno between @emp_f and @emp_t --Bornage sur l'Employé
and dontemp.t_proc between @traite_f and @traite_t --Bornage sur traite oui ou non
--rajout par rbesnier le 31/08/2017
and emp.t_cwoc between @cc_f and @cc_t --Bornage sur le Département de l'Employé
...
left outer join ttcmcs052500 prj on prj.t_cprj = donof.t_cprj --Projet
where left(donof.t_orno, 2) between @ue_f and @ue_t --Bornage sur l'UE
and donof.t_peri between datepart(dayofyear, @jour_f) and datepart(dayofyear, @jour_t) --Bornage sur le jour
and donof.t_year between datepart(year, @jour_f) and datepart(year, @jour_t) --Bornage sur l'année
and donof.t_emno between @emp_f and @emp_t --Bornage sur l'Employé
and donof.t_proc between @traite_f and @traite_t --Bornage sur traite oui ou non
--rajout par rbesnier le 31/08/2017
and emp.t_cwoc between @cc_f and @cc_t --Bornage sur le Département de l'Employé
...
left outer join ttcmcs048500 prev on prev.t_cpcp = hdprj.t_cpcp --Element Prix de Revient
where left(hdprj.t_cprj, 2) between @ue_f and @ue_t --Bornage sur l'UE
and hdprj.t_peri between datepart(dayofyear, @jour_f) and datepart(dayofyear, @jour_t) --Bornage sur le jour
and hdprj.t_year between datepart(year, @jour_f) and datepart(year, @jour_t) --Bornage sur l'année
and hdprj.t_emno between @emp_f and @emp_t --Bornage sur l'Employé
and hdprj.t_proc between @traite_f and @traite_t --Bornage sur traite oui ou non
--rajout par rbesnier le 31/08/2017
and emp.t_cwoc between @cc_f and @cc_t --Bornage sur le Département de l'Employé
...
left outer join ttcmcs052500 prj on prj.t_cprj = donprj.t_cprj --Projet
where left(donprj.t_cprj, 2) between @ue_f and @ue_t --Bornage sur l'UE
and donprj.t_peri between datepart(dayofyear, @jour_f) and datepart(dayofyear, @jour_t) --Bornage sur le jour
and donprj.t_year between datepart(year, @jour_f) and datepart(year, @jour_t) --Bornage sur l'année
and donprj.t_emno between @emp_f and @emp_t --Bornage sur l'Employé
and donprj.t_proc between @traite_f and @traite_t --Bornage sur traite oui ou non
--rajout par rbesnier le 31/08/2017
and emp.t_cwoc between @cc_f and @cc_t --Bornage sur le Département de l'Employé
...
left outer join ttcmcs048500 prev on prev.t_cpcp = donos.t_cpcp --Element Prix de Revient
where left(donos.t_orno, 2) between @ue_f and @ue_t --Bornage sur l'UE
and donos.t_peri between datepart(dayofyear, @jour_f) and datepart(dayofyear, @jour_t) --Bornage sur le jour
and donos.t_year between datepart(year, @jour_f) and datepart(year, @jour_t) --Bornage sur l'année
and donos.t_emno between @emp_f and @emp_t --Bornage sur l'Employé
and donos.t_proc between @traite_f and @traite_t --Bornage sur traite oui ou non
--rajout par rbesnier le 31/08/2017
and emp.t_cwoc between @cc_f and @cc_t --Bornage sur le Département de l'Employé
