...
where (tiers.t_lmdt between @date_f and @date_t and left(tiers.t_crdt, 10) != left(tiers.t_lmdt, 10)) --Date Modification du Tiers et on vérifie que la date de création ne soit pas celle du jour
or (tiersacheteur.t_lmdt between @date_f and @date_t and left(tiersacheteur.t_crdt, 10) != left(tiersacheteur.t_lmdt, 10)) --Date Modification/Creation du Tiers Acheteur
or (tiersdestinataire.t_lmdt between @date_f and @date_t and left(tiersdestinataire.t_crdt, 10) != left(tiersdestinataire.t_lmdt, 10)) --Date Modification/Creation du Tiers Destinataire
or (tiersfacture.t_lmdt between @date_f and @date_t and left(tiersfacture.t_crdt, 10) != left(tiersfacture.t_lmdt, 10)) --Date Modification/Creation du Tiers Facture
or (tierspayeur.t_lmdt between @date_f and @date_t and left(tierspayeur.t_crdt, 10) != left(tierspayeur.t_lmdt, 10)) --Date Modification/Creation du Tiers Payeur
or (tiersvendeur.t_lmdt between @date_f and @date_t and left(tiersvendeur.t_crdt, 10) != left(tiersvendeur.t_lmdt, 10)) --Date Modification/Creation du Tiers Vendeur
or (tiersexpediteur.t_lmdt between @date_f and @date_t and left(tiersexpediteur.t_crdt, 10) != left(tiersexpediteur.t_lmdt, 10)) --Date Modification/Creation du Tiers Expéditeur
or (tiersfacturant.t_lmdt between @date_f and @date_t and left(tiersfacturant.t_crdt, 10) != left(tiersfacturant.t_lmdt, 10)) --Date Modification/Creation du Tiers Facturant
or (tierspaye.t_lmdt between @date_f and @date_t and left(tierspaye.t_crdt, 10) != left(tierspaye.t_lmdt, 10)) --Date Modification/Creation du Tiers Payeur
